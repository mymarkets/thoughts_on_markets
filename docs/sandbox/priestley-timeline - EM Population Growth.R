# https://gist.github.com/hrbrmstr/f12101f8ef1657f9e1457e0dde1602f8#file-ftpop-csv


ft <- tibble::tribble(
       ~country, ~start_year, ~double, ~triple,
       "France",       1865L,    115L,     42L,
      "Sweeden",       1890L,     85L,     40L,
           "UK",       1930L,     45L,     55L,
    "Australia",       1938L,     73L,     26L,
           "US",       1944L,     69L,     20L,
        "Spain",       1947L,     45L,     34L,
      "Hungary",       1941L,     53L,     27L,
       "Poland",       1966L,     45L,     13L,
        "Chile",       1999L,     26L,     16L,
       "Brazil",       2012L,     21L,     17L,
      "Tunisia",       2007L,     24L,     13L,
        "Japan",       1970L,     25L,     12L,
     "Thailand",       2003L,     21L,     14L,
        "China",       2001L,     23L,     11L,
  "South Korea",       2000L,     18L,      9L
  )
...
gg <- gg + geom_segment(data=ft, size=5, color="#eb9c9d",
                        aes(x=start_year+double, 
                            xend=start_year+double+triple, y=country, yend=country))
